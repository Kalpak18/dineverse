...
const STEPS = [
  ...
  },
  {
    ...
    why: 'A clear, polished menu helps customers order quickly and reduces questions for staff.',
    hints: [
      'Manually add menu categories and items in Menu → Categories',
      'Include price, portion size, and a clear description for each dish',
      'Mark veg / non-veg and add dietary tags like Spicy, Vegan, Gluten-Free',
      'Add item photos to help customers order with confidence',
      'Enable stock tracking only if you want to manage limited quantities',
    ],
    action: 'Open Menu →',
    route: '/owner/menu',
  ...
  },
  {
    ...
    hints: [
      ...
      'Copy your DineVerse café link and share it with customers',
      'WhatsApp your regulars: "We\'re now on DineVerse — order here!"',
      'Download table QR codes and place them on tables for quick ordering',
      'Share the link on Instagram, Google Business, WhatsApp, and printed menus',
    ],
