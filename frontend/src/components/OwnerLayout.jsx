...
const ALL_NAV = [
  ...
  { to: '/owner/shift',        label: 'Shift',        icon: 'shift',        roles: ['owner', 'manager', 'cashier'] },
  { to: '/owner/loyalty',      label: 'Loyalty',      icon: 'loyalty',      roles: ['owner', 'manager'] },
  { to: '/owner/modifiers',    label: 'Add-ons',      icon: 'modifiers',    roles: ['owner', 'manager'] },
